...
public:
    ...
    void begin(void);
    static void esp_TX(void *arg);
    static void esp_RX(void *parameter);
    ...
    void suspend_device();
    void resume_device();
    bool process_TX(const char *format, ...);
    ...
    // Declare the handleDescriptor function
    void handleDescriptor(uint8_t bDescriptorType, const uint8_t *p);
